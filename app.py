...
from views.rl_page import show_rl_page
from views.tft_page import show_tft_page
...
<div style="text-align: center; padding: 10px 0 20px 0; border-bottom: 1px solid rgba(255,255,255,0.1); margin-bottom: 16px;">
    <h1 style="font-size: 1.8rem; margin: 0; color: #4da6ff;">📈 FinSight AI</h1>
    <p style="color: rgba(255,255,255,0.5); font-size: 0.85rem; margin-top: 4px;">AI-Powered Stock Intelligence</p>
</div>
""", unsafe_allow_html=True)

# Main Navigation
page = st.sidebar.radio("Navigate", ["Stock Forecast", "Portfolio Analysis", "Advanced AI", "RL Trading Agent", "Multi-Variate TFT", "About"])
...
if page == "Stock Forecast":
    ...
    show_ai_page()
elif page == "RL Trading Agent":
    show_rl_page()
elif page == "Multi-Variate TFT":
    show_tft_page()
elif page == "About":
    st.title("About FinSight AI")
    
    st.markdown("### 🚀 AI-Powered Stock Market Intelligence")
    st.markdown("FinSight AI uses AI models to analyze stocks, predict prices, and optimize your portfolio — all in one app.")
